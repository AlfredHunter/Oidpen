...
#define WD_INIT_1000MS()        st( WDCTL = 0x00; WDCTL |= 0x08; )                      //¼ä¸ôÊ±¼äÎª1000MSµÄ¿´ÃÅ¹·Æô¶¯  
#define WD_INIT_250MS()         st( WDCTL = 0x00; WDCTL |= 0x01; WDCTL |= 0x08; )       //¼ä¸ôÊ±¼äÎª250MSµÄ¿´ÃÅ¹·Æô¶¯  
#define WD_INIT_15_625MS()      st( WDCTL = 0x00; WDCTL |= 0x02; WDCTL |= 0x08; )       //¼ä¸ôÊ±¼äÎª15.625MSµÄ¿´ÃÅ¹·Æô¶¯  
#define WD_INIT_1_9MS()         st( WDCTL = 0x00; WDCTL |= 0x03; WDCTL |= 0x08; )       //¼ä¸ôÊ±¼äÎª1.9MSµÄ¿´ÃÅ¹·Æô¶¯  
