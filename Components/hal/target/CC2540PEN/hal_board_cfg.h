...
#define HAL_CONFIG_IO_INPUT(port, pin, func)  MCU_IO_INPUT_PREP(port, pin, func)
#define	HAL_IO_SET_HIGH(port, pin)     MCU_IO_SET_HIGH_PREP(port, pin)
#define HAL_IO_SET_LOW(port, pin)      MCU_IO_SET_LOW_PREP(port, pin)
#define HAL_IO_TGL(port, pin)          MCU_IO_TGL_PREP(port, pin)
#define HAL_IO_GET(port, pin)          MCU_IO_GET_PREP(port, pin)
...
/* MIC communication channel */
#define HAL_MIC_OUT_PORT                1
#define HAL_MIC_OUT_PIN                 3
#define HAL_MIC_INSERT_PORT            0
#define HAL_MIC_INSERT_PIN             0

/* OID_CONTROL */
#define HAL_OID_RST_PORT               0
#define HAL_OID_RST_PIN                4
#define HAL_OID_POWER_PORT             0
#define HAL_OID_POWER_PIN              6
#define HAL_OID_WAKEUP_PORT            1
#define HAL_OID_WAKEUP_PIN             2

/* OID COMMUNICATION (SPI) */
//just define HAL_UART_SPI==2, system can configure it automatically
#define HAL_SPI_PORT                 1
#define HAL_SPI_CS_PIN               4

#if 0  // - zhj É¾³ý20160115
/* BATTERY DETECT */
#define HAL_BATT_DETECT_PORT         0
#define HAL_BATT_DETECT_PIN          3
#endif
...
#define HAL_TURN_OFF_LED_B()       HAL_IO_SET_HIGH(HAL_LED_B_PORT,HAL_LED_B_PIN)
#define HAL_TURN_ON_LED_B()        HAL_IO_SET_LOW(HAL_LED_B_PORT,HAL_LED_B_PIN)
#define HAL_TOGGLE_LED_B()         HAL_IO_TGL(HAL_LED_B_PORT,HAL_LED_B_PIN)
#define HAL_STATE_LED_B()          HAL_IO_GET(HAL_LED_B_PORT,HAL_LED_B_PIN)

// -- zhj
#define HAL_TURN_OFF_LED_R()       HAL_IO_SET_HIGH(HAL_LED_R_PORT,HAL_LED_R_PIN)
#define HAL_TURN_ON_LED_R()        HAL_IO_SET_LOW(HAL_LED_R_PORT,HAL_LED_R_PIN)
#define HAL_TOGGLE_LED_R()         HAL_IO_TGL(HAL_LED_R_PORT,HAL_LED_R_PIN)
#define HAL_STATE_LED_R()          HAL_IO_GET(HAL_LED_R_PORT,HAL_LED_R_PIN)

#define HAL_TURN_OFF_LED_G()       HAL_IO_SET_HIGH(HAL_LED_G_PORT,HAL_LED_G_PIN)
#define HAL_TURN_ON_LED_G()        HAL_IO_SET_LOW(HAL_LED_G_PORT,HAL_LED_G_PIN)
#define HAL_TOGGLE_LED_G()         HAL_IO_TGL(HAL_LED_G_PORT,HAL_LED_G_PIN)
#define HAL_STATE_LED_G()          HAL_IO_GET(HAL_LED_G_PORT,HAL_LED_G_PIN)
...
#define HAL_SHAKER_OFF()           HAL_IO_SET_LOW(HAL_SHAKER_PORT,HAL_SHAKER_PIN)
#define HAL_INIT_SHAKER()          HAL_CONFIG_IO_OUTPUT(HAL_SHAKER_PORT,HAL_SHAKER_PIN,0)

#define HAL_TURN_ON_MOTOR()       HAL_IO_SET_HIGH(HAL_SHAKER_PORT,HAL_SHAKER_PIN)
#define HAL_TURN_OFF_MOTOR()        HAL_IO_SET_LOW(HAL_SHAKER_PORT,HAL_SHAKER_PIN)
#define HAL_TOGGLE_MOTOR()         HAL_IO_TGL(HAL_SHAKER_PORT,HAL_SHAKER_PIN)
...
#define HAL_OID TRUE
#endif
/* Set to TRUE enable SHAKER usage, FALSE disable it */
#ifndef HAL_SHAKER
#define HAL_SHAKER TRUE
#endif
