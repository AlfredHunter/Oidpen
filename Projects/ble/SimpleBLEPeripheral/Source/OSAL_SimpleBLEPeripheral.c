...
const pTaskEventHandlerFn tasksArr[] =
{
  ...
  gSensorApp_ProcessEvent,                                          // task 11
...
void osalInitTasks( void )
{
  ...
  /* Profiles */
  GAPRole_Init( taskID++ );/*GAP层的配制*/
  GAPBondMgr_Init( taskID++ );/*蓝牙绑定的管理初始化*/

  GATTServApp_Init( taskID++ );/*GATT层服务的初始化*/

  /* Application */
  gSensorApp_Init( taskID++ );
