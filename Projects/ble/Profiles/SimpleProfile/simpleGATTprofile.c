...
static uint8 simpleProfileChar1UserDesp[8] = "AXIS_X\0";
...
static uint8 simpleProfileChar2UserDesp[8] = "AXIS_Y\0";
...
static uint8 simpleProfileChar3UserDesp[8] = "AXIS_Z\0";
...
static uint16 simpleProfileChar4 = 0;
...
static uint8 simpleProfileChar4UserDesp[10] = "Dish Code\0";
  ...
  switch ( param )
  {
    case SIMPLEPROFILE_CHAR1:
      if ( len == sizeof ( uint16 ) ) 
      {
        ...
        GATTServApp_ProcessCharCfg( simpleProfileChar1Config, (uint8 *)&simpleProfileChar1, FALSE,
    ...
    case SIMPLEPROFILE_CHAR2:
      if ( len == sizeof ( uint16 ) ) 
      {
        ...
        // See if Notification has been enabled
        GATTServApp_ProcessCharCfg( simpleProfileChar2Config, (uint8 *)&simpleProfileChar2, FALSE,
                                    simpleProfileAttrTbl, GATT_NUM_ATTRS( simpleProfileAttrTbl ),
                                    INVALID_TASK_ID );
      }
      else
    ...
    case SIMPLEPROFILE_CHAR3:
      if ( len == sizeof ( uint16 ) ) 
      {
        ...
        // See if Notification has been enabled
        GATTServApp_ProcessCharCfg( simpleProfileChar3Config, (uint8 *)&simpleProfileChar3, FALSE,
                                    simpleProfileAttrTbl, GATT_NUM_ATTRS( simpleProfileAttrTbl ),
                                    INVALID_TASK_ID );
      }
      else
